...
class LoginController extends Controller
{
    ...
    */
    ...
    public function showWebLoginForm()
    {
        ...
        return view('website.webAuth.log' , compact('auctions'));
    }
    ...
    public function webLogin(Request $request)
    {
        ...
        if (Auth::guard('webuser')->attempt(['identity' => $request->identity, 'password' => $request->password], $request->get('remember'))) {
            
                /*  $webuser = Auth::User();
               
                Session::put('email', $webuser->email);
                Session::put('Firstname', $webuser->Firstname);
                Session::put('phone', $webuser->phone); 
                Toastr::success('Login successfully :)','Success');
 */
