    ...
    return {
        init: function () {
            ...
            e > 1024 && $(".metismenu  li").unbind().each(function (e) {
                if ($("ul", this).length > 0) {
                    var t = (a = $("ul:first", this).css("display", "block")).offset().left, n = a.width(),
                        a = $("ul:first", this).removeAttr("style"), l = ($("body").height(), $("body").width());
                    if (jQuery("html").hasClass("rtl")) var o = t + n <= l; else o = t > 0;
