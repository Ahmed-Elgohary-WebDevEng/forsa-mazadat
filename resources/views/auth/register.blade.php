                ...
                <div class="row no-gutters">
                    <div class="col-xl-12">
                        <div class="auth-form">
                            ...
                            <h4 class="text-center mb-4">سجل مستخدم جديد</h4>
                            <form action="{{ route('register') }}" method="POST">
                                @csrf
                                <div class="mb-3">
                                    <label class="mb-1"><strong> الاسم</strong></label>
                                ...
                                <div class="mb-3">
                                    <label class="mb-1"><strong> تاكيد كلمة المرور</strong></label>
                            ...
                            {{--<div class="new-account mt-3">
                                <p>Already have an account? <a class="text-primary" href="{{route('login')}}"> حفظ</a></p>
                            </div>--}}
                        </div>
                    </div>
                </div>
