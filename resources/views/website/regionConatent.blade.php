...
{{-- 
<div class="container-lg mx-auto mt-5 droid-arabic-kufi">

        <div class="row row-cols-1 row-cols-md-3 g-4 droid-arabic-kufi" dir="rtl" >
          ...
          <div class="col">
            <div class="card h100">
              <img src="{{asset('uploads/auction/'.$item->image)  }}" alt="" width="30" height="150" class="card-img-top mt-3">
              <div class="card-body ">
                <h5 class="card-title text-center mt-4" style="color: rgb(35, 96, 86);">{{$item->Title}}</h5>
                <p class="card-text"  style="color: rgb(83, 210, 187)">  التفاصيل:  <span   style="color: rgb(35, 96, 86);"> {{$item->description}} </span></p>
                <p class="card-text" style="color: rgb(83, 210, 187)">  تاريخ البداية:  <span  style="color: rgb(35, 96, 86);"> {{$item->dateOfStarting}}</span></p>
                <p class="card-text" style="color: rgb(83, 210, 187)">  تاريخ النهاية:  <span  style="color: rgb(35, 96, 86);"> {{$item->dateOfEnding}}</span></p>
                <a href="{{url('AcutionItems/'.$item->slug)}}" class="btn btn-outline-warning float-start" style="color: #fac68a;">المزيد </a>
              </div>
            </div>
          </div>
...
<div class="container-lg mx-auto mt-5 droid-arabic-kufi">
  ...
  <ul class="nav nav-pills p-0 nav-justified mb-3" id="pills-tab" role="tablist">
    ...
    <li class="nav-item ms-5 me-5" role="presentation">
  ...
  <select class="form-select"  id="roleDropdown" onchange='filterText1()'>
        ...
        <div class="card content">
          ...
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-6">
                <p class="card-text" style="color: rgb(83, 210, 187);font-size:12px"> المنطقة: <span
                    style="color: rgb(35, 96, 86);">
			...
			<a class="btn Btn-position rounded-pill btn-outline-Green Btn-lightGreen "> جاري </a>
              ...
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col-6">
                    <p class="card-text" style="color: rgb(83, 210, 187)"> المنطقة: <span
