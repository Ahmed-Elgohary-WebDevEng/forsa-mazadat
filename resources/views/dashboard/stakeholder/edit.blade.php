    ...
    <div class="row">
        <div class="col-xl-12">
            ...
            <div class="card">                
                ...
                <div class="card-body">
                    <form action="{{ url('update-stakeholder/'.$stakeholder->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-4">
                                ...
                                <input type="text" value="{{$stakeholder->name}}"  name="name" class="form-control">
                            </div>
                            <div class="mb-3 col-md-4">
                                <label for="">الرابط</label>
                                <input type="text" name="link" value="{{$stakeholder->link}}"   class="form-control">
                            </div>
                            <div class="mb-3 col-md-4">
                                <label for="">الشعار</label>
                                <input type="file" name="logo" class="form-control">
                                <img src="{{ asset('uploads/logo/'.$stakeholder->logo) }}" width="70px" height="70px" alt="Image">
