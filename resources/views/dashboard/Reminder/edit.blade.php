    ...
    <div class="container-fluid">
        <div class="row page-titles">
            <ol class="breadcrumb d-flex justify-content-end" dir="ltr">
                ...
                <li class="breadcrumb-item "> <a href="{{ url('auctionitem') }}"> محتوى المزاد</a></li>
        ...
        <div class="col-xl-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-xl-12">
                            <form action="{{ url('update_auctionitem/'.$Actionitems->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <textarea type="text" name="description" class="form-control" value="{{$Actionitems->description}}"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <textarea type="text" name="lowPrice" class="form-control" value="{{$Actionitems->lowPrice}}"></textarea>
                                    </div>
                                </div>
