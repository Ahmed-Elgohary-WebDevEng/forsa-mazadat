        ...
        <div class="container-fluid">
            <div class="row page-titles">
                <ol class="breadcrumb d-flex justify-content-end" dir="ltr">
                    <li class="breadcrumb-item active"><a href="{{ url('edit_auction/'.$auction->id)}}">تعديل
                            المزادات</a></li>
                                        ...
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <div class="input-group mb-3">
                                                <select id="auctionType" class="form-select" aria-label="Default select example" name="type" onchange="changeFunc();">
                                                    <option value="online" {{$auction->type == 'online' ? 'selected':''}}>
                                                        إلكتروني
                                                    </option>
                                                    <option value="onsite"{{$auction->type == 'onsite' ? 'selected':''}}>
                                                        حضوري
                                                    </option>
                                                    <option value="mixed"{{$auction->type == 'mixed' ? 'selected':''}}>
                                                        هجين
                                                    </option>
                                        ...
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <div class="input-group mb-3">
                                                <select class="form-select" aria-label="Default select example" name="Region">
                                                    ...
                                                    <option value="riyadh" {{$auction->Region == 'riyadh' ? 'selected':''}} >
                                                        الرياض
                                                    </option>
                                                    <option value="makka" {{$auction->Region == 'makka' ? 'selected':''}} >
                                                        مكة المكرمة
                                                    </option>
                                                    <option value="almadina" {{$auction->Region == 'almadina' ? 'selected':''}} >
                                                        المدينة المنورة
                                                    </option>
                                                    <option value="alsharqia" {{$auction->Region == 'alsharqia' ? 'selected':''}} >
                                                        المنظقة الشرقية
                                                    </option>
                                                    <option value="aljuof" {{$auction->Region == 'aljuof' ? 'selected':''}} >
                                                        الجوف
                                                    </option>
                                                    <option value="tabuk" {{$auction->Region == 'tabuk' ? 'selected':''}} >
                                                        تبوك
                                                    </option>
                                                    <option value="haael" {{$auction->Region == 'haael' ? 'selected':''}} >
                                                        حائل
                                                    </option>
                                                    <option value="qassim" {{$auction->Region == 'qassim' ? 'selected':''}} >
                                                        القصيم
                                                    </option>
                                                    <option value="najran" {{$auction->Region == 'najran' ? 'selected':''}} >
                                                        نجران
                                                    </option>
                                                    <option value="jazan" {{$auction->Region == 'jazan' ? 'selected':''}}>
                                                        جازان
                                                    </option>
                                                    <option value="albaha" {{$auction->Region == 'albaha' ? 'selected':''}} >
                                                        الباحة
                                                    </option>
                                                    <option value="shmaleah" {{$auction->Region == 'shmaleah' ? 'selected':''}}>
                                                        المنطقة الشمالية
                                                    </option>
                                                    <option value="asser" {{$auction->Region == 'asser' ? 'selected':''}}>
                                                        عسير
                                                    </option>
                                                </select>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="time" name="timeOfEnding" value="{{ $auction->timeOfEnding }}" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <div class="input-group mb-3">
                                                <select class="form-select" aria-label="Default select example" name="ShowInfath">
                                                    <option value="yes" {{$auction->ShowInfath == 'yes' ? 'selected':''}}>
                                                        إظهار
                                                    </option>
                                                    <option value="no" {{$auction->ShowInfath == 'no' ? 'selected':''}}>
                                                        إخفاء
                                                    </option>
                                                </select>
                                            </div>
