                    ...
                    <form action="{{ url('add_auction') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                         ...
                         <div class="mb-3 col-md-8">
                            ...
                            <input type="url" name="onsiteLinkoo" class="form-control "  style="display: none" id="textboxes">
                        </div>
 <div class="mb-3 col-md-8">
                            <label for="" style="display: none" id="textboxee">رابط مكان القاعه </label>

                            <input type="url" name="onsiteLink" class="form-control "  style="display: none" id="textboxese">
                        </div>
                        <div class="mb-3 col-md-6">
                            ...
                            <div class="row">
                                ...
                                <input type="date" name="dateOfStarting" class="form-control">
                            </div>
                            <div class="mb-3 col-md-6">
                                <label for="">تاريخ النهاية</label>
                                <input type="date" name="dateOfEnding" class="form-control">
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="time" name="timeOfStarting"  class="form-control">
                            </div>
