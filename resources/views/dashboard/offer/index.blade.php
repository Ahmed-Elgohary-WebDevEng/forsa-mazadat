        ...
        <div class="container-fluid">
            <div class="row page-titles">
                <ol class="breadcrumb d-flex justify-content-end" dir="ltr">
                    ...
                    <li class="breadcrumb-item active"><a href="{{ route('offers.index') }}">العروض المميزة</a></li>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header  d-flex justify-content-between ">
                            ...
                            <p class="text-center  fs-3 fw-bold text-primary">عرض جميع العروض</p>
                            <a href="{{ route('offers.create') }}" class="btn btn-primary float-end">أضف جديد</a>
                        </div>
                        @if (session('status'))
